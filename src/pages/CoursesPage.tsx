        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {data?.courses.map((course) => (
            <button
              ...
              className="bg-white rounded-xl shadow-sm p-5 flex flex-col gap-3 text-left hover:shadow-md transition-shadow"
            >
              <div className="w-full h-28 rounded-lg bg-indigo-50 flex items-center justify-center">
